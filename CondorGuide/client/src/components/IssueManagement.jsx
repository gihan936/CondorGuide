...
const IssueManagement = () => {
  ...
  useEffect(() => {
    ...
    if (departmentFilter) filtered = filtered.filter(i => i.mainCategory.toLowerCase().includes(departmentFilter.toLowerCase()));
            ...
            <>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select
                  ...
                  onChange={(e) =>
                    setEditFields((prev) => ({ ...prev, status: e.target.value }))
                  }
                >
                  {STATUSES.map((s) => (
                    <option key={s} value={s}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEditFields((prev) => ({ ...prev, mainCategory: e.target.value }))
                  }
                />
              </Form.Group>
              <hr />
